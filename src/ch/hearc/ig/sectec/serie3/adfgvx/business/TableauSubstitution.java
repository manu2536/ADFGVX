...
public class TableauSubstitution {
	...
	public TableauSubstitution() {
            ...
            this.subTable.put("D", new String[]{"A","D"});
            this.subTable.put("c", new String[]{"A","F"});
            this.subTable.put("D", new String[]{"A","G"});
            this.subTable.put("c", new String[]{"A","V"});
            this.subTable.put("D", new String[]{"A","X"});
